...
// Auto Play Videos when on screen
$(window).scroll(function(){$('video').each(function(){ if($(window).width() > 768){if ($(this).is(":in-viewport( -"+($(window).height()/3*2)+" )")){$(this)[0].play();}}else if($(this).is(":in-viewport")){$(this)[0].play();}})});	